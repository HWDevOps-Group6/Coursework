...
describe('vitalsService (integration)', function() {
  ...
  it('getVitals should return vitals array', async () => {
    await Vitals.create({ patientId: 'p1', temperature: 37, bp_systolic: 120, bp_diastolic: 80, pulse: 70, source: 'device', createdBy: 'Nurse', updatedBy: 'Nurse' });
    const req = { params: { patientId: 'p1' } };
    const res = { json: function(data) { this.data = data; return this; } };
