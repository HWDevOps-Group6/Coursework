...
describe('authService (integration)', function() {
  ...
  describe('register', () => {
    it('should create user and return token', async () => {
      const result = await authService.register({ email: 'new@example.com', password: 'pw123456', firstName: 'A', lastName: 'B' });
    ...
    it('should throw if user exists', async () => {
      await authService.register({ email: 'new@example.com', password: 'pw123456', firstName: 'A', lastName: 'B' });
      try {
        await authService.register({ email: 'new@example.com', password: 'pw123456', firstName: 'A', lastName: 'B' });
